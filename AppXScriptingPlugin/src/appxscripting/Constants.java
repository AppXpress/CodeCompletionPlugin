package appxscripting;

public class Constants {
	
	public static String WIZARD_TITLE = "New Platform Module Scripting Project";
	public static String PAGE_ONE_NAME = "Platform Module Scripting Project Wizard";
	public static String PAGE_ONE_TITLE = "Create Scripting Project";
	public static String PAGE_ONE_DESC = "Enter a project name.";
	public static String PAGE_TWO_NAME = "Platform Module Scripting Project Wizard";
	public static String PAGE_TWO_TITLE = "Connect to AppXpress";
	public static String PAGE_TWO_DESC = "Enter authorization details.";
	...
	public static String PAGE_TWO_DATA_KEY = "Value for data key:";
	public static String PAGE_TWO_UNAME = "Username:";
	public static String PAGE_TWO_PWD = "Password:";
